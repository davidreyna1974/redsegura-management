...
| `arquitectura/` | `memoria_tecnica_global_TEMPLATE.md`, `diagrama_arquitectura_TEMPLATE.md`, `especificacion_tecnica_TEMPLATE.md`, `preparacion_produccion_TEMPLATE.md` | Al definir la arquitectura del sistema y la preparación a producción (RNF por etapa) |
| `modulos/` | `propuesta_modulo_TEMPLATE.md`, `memoria_tecnica_modulo_TEMPLATE.md` | Antes y durante cada módulo/feature |
| `qa/` | `casos_de_prueba_TEMPLATE.md`, `protocolo_verificacion_4_fases_TEMPLATE.md`, `reporte_qa_TEMPLATE.md`, `analisis_pruebas_TEMPLATE.md`, `verificacion_endpoints_TEMPLATE.md`, `matriz_rnf_TEMPLATE.md` | Para definir, ejecutar y certificar pruebas (incl. verificación en vivo de endpoints y matriz de trazabilidad de RNF por servicio) |
| `uat/` | `plan_uat_TEMPLATE.md`, `uat_servicio_TEMPLATE.md` (→ `guion_uat.md`), `demo_guiada_TEMPLATE.md` | Aceptación con el cliente: plan general + por servicio (criterios/firma + demo guiada) |
